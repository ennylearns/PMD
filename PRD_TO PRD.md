...
- `GET /api/shipping/rates` - Get GIG shipping rates
- `POST /api/shipping/create-order` - Create GIG logistics order
...
- Use Playwright for integration tests (critical flows)
- Mock external services (Paystack, GIG Logistics) in tests
