...
- [ ] Delivery fee policy is based on delivery state/city from Jos, Plateau
- [ ] Supported State/City options start as a curated major-city/state-capital list and become admin-manageable later
